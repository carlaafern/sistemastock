...
{
    public class IDireccion:Intermediario
    {
        ...
        private Provincia provincia;
            ...
            public override void save<T>(T entity)
            {
                try
                {
                    Direccion dir = entity as Direccion;
                    dao.Direccions.InsertOnSubmit(dir);
            ...
            {
                return (from d in dao.Direccions select d).ToList() as List<T>;
            }
